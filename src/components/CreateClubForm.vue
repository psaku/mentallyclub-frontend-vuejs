            ...
            <q-card class="create-form-card">
                ...
                <q-form @submit="onSubmitForm" class="q-gutter-y-md">
                    <q-card-section class="row q-gutter-md">
                        ...
                        <q-input v-model="formClub.clubfoundingdate" label="วันที่ก่อตั้งชมรม" filled type="date"
                            :value="currentDate" />
                    ...
                    <q-card-section class="row q-gutter-md">
                        ...
                        <div class="column">
                            <q-input v-model="formClub.zipcode" label="รหัสไปรษณีย์" filled type="search" :rules="[
                                (val) => (val && val.length > 0) || 'Name must be filled in.',
                            ]">
                                <template v-slot:append>
